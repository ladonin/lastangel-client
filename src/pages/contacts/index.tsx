      ...
      <div className="page-contacts">
        <div className="loc_left">
          ...
          <div className="loc_phone">
            ...
            <div className="loc_fio">{MAIN_CARD_OWNER}</div>
          </div>
          <div className="loc_content_1">
            Приют находится в Александровском р-не, Владимирской обл.
            <br />
            Если Вы хотите посетить наш приют, в частности, привезти питомцам корм и/или любую
            другую помощь, познакомиться с ними, просим Вас звонить по вышеуказанному телефону - Вам
            сообщат точный адрес и как лучше добраться.
          </div>
