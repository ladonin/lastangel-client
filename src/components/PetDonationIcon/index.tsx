...
import d2_5Icon from "./icons/dogs/2/5.png";
...
import d3_5Icon from "./icons/dogs/3/5.png";
...
const ICONS = {
  cats: {
    1: [c1_1Icon, c1_2Icon, c1_3Icon, c1_4Icon, c1_5Icon],
    2: [c2_1Icon, c2_2Icon, c2_3Icon, c2_4Icon],
    3: [c3_1Icon],
    4: [c4_1Icon],
    5: [c5_1Icon, c5_2Icon, c5_3Icon, c5_4Icon],
    6: [c6_1Icon, c6_2Icon],
    7: [c7_1Icon, c7_2Icon, c7_3Icon],
    8: [c8_1Icon, c8_2Icon, c8_3Icon, c8_4Icon],
    9: [c9_1Icon, c9_2Icon],
  },
  dogs: {
    1: [d1_1Icon, d1_2Icon, d1_3Icon, d1_4Icon, d1_5Icon, d1_6Icon, d1_7Icon, d1_8Icon],
    2: [d2_1Icon, d2_2Icon, d2_3Icon, d2_4Icon, d2_5Icon],
    3: [d3_1Icon, d3_2Icon, d3_3Icon, d3_4Icon, d3_5Icon],
    4: [d4_1Icon, d4_2Icon, d4_3Icon],
    5: [d5_1Icon, d5_2Icon],
    6: [d6_1Icon, d6_2Icon, d6_3Icon],
    7: [d7_1Icon, d7_2Icon, d7_3Icon, d7_4Icon, d7_5Icon, d7_6Icon],
    8: [d8_1Icon, d8_2Icon, d8_3Icon, d8_4Icon, d8_5Icon, d8_6Icon, d8_7Icon, d8_8Icon, d8_9Icon, d8_10Icon, d8_11Icon],
    9: [d9_1Icon, d9_2Icon, d9_3Icon, d9_4Icon],
  },
};
...
const PetDonationIcon: React.FC<TProps> = (props) => {
  ...
  const petDonationIcons: {
    [key: number]: { collected: number; icon: string };
  } = loadItem("petDonationIcons");

  useEffect(() => {
    if (pet) {
      const collected = pet.collected || 0;
      if (petDonationIcons[pet.id] && petDonationIcons[pet.id].icon && petDonationIcons[pet.id].collected === collected) {
        setIconState(petDonationIcons[pet.id].icon);
      } else {
        ...
        saveItem("petDonationIcons", {
          ...petDonationIcons,
          [pet.id]: {
            collected,
            icon: icons[number] || null,
          },
        });
